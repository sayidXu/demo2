...
public class Test {
	public static void main(String[] args){
		//连接redis
		Jedis redis = new Jedis("172.16.90.34",6379);
		//验证密码 
		redis.auth("test123");
...
//        }
	...
	public static void testString(Jedis redis){
		/**  STRING 操作   */
	...
	public static void testHashMap(Jedis redis){
		/**  Hash 操作   */
	...
	public static void testList(Jedis redis){
		 /**  LIST 操作   */
	...
	public static void testSet(Jedis redis){
		/**  SET 操作   */
